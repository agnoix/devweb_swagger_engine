...
function program20(depth0,data) {
  ...
  return "\n          <div class='sandbox_header'>\n            <input class='submit' name='commit' type='button' value='Try it out!' /> <input class='submitCurl' name='curlit' type='button' value='Show Curl' />\n            <a href='#' class='response_hider' style='display:none'>Hide Response</a>\n            <span class='response_throbber' style='display:none'></span>\n          </div>\n          ";
  }
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n        </form>\n        <div class='buildCurl' style='display: none;'><h4>Curl</h4><div class='block curl'></div></div>\n          <div class='response' style='display:none'>\n          <h4>Request URL</h4>\n          <div class='block request_url'></div>\n          <h4>Response Body</h4>\n          <div class='block response_body'></div>\n          <h4>Response Code</h4>\n          <div class='block response_code'></div>\n          <h4>Response Headers</h4>\n          <div class='block response_headers'></div>\n        </div>\n      </div>\n    </li>\n  </ul>\n";
  return buffer;
  });
})();
...
function program1(depth0,data) {
  ...
  var idx = stack1.indexOf('.');
  var prettystack1 = stack1;
  if (idx > 0) {
	  prettystack1 = stack1.substring(0, idx);
  }
  buffer += escapeExpression(prettystack1)
    + "</a> ";
  options = {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data};
...
(function() {
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.events = {
      ...
      'click .submitCurl': 'buildCurlOperation',
    ...
    OperationView.prototype.render = function() {
      ...
      // Disable Try It Out in some cases
      if(this.model.disableSandbox) {
        $('input.submit', $(this.el)).get(0).disabled = "disabled";
      }
    ...
    OperationView.prototype.buildCurlOperation = function(e) {
      // res : for the moment, this is primarily a copy/paste from the submitOperation method
      //       some de-duplication would be good, but intentionally the same for now
      ...
      if (error_free) {
        ...
        // Output as curl
        $(".curl", $(this.el)).html("<textarea readonly='readonly'></textarea>");
        var textarea = $(".curl textarea", $(this.el))
        textarea.html(_.escape(this.model.asCurl(map, opts)));

        // Show the curl box
        $(".buildCurl", $(this.el)).show();

        // Resize textarea to fit, but this only works when it's visible
        textarea.get(0).style.height = (10 + textarea.get(0).scrollHeight) + "px"; // resize to fit
      }
    };
